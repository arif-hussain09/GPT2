...
from Dataset.hellaswag.hellaswag import render_example, iterate_examples
# -------------------------------------------------------------------------------
...
class GPT2Model(nn.Module):
    ...
    @classmethod # copied from nano -gpt implementation
...
if __name__ == "__main__":
    ...
    # create model
    model = GPT2Model(GPT2Config(vocab_size=50304))
        ...
        if step % 250 == 0 or last_step:
            ...
            with torch.no_grad():
                ...
                for _ in range(val_loss_steps):
                    ...
                    # aggregating the losses across the micro-batches and averaging them
